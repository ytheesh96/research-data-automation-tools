...
| --- | --- | --- | --- |
| Photochemistry planning | [Photodimerization Scout](https://github.com/ytheesh96/photodimerization-scout) | `photodimerization-scout` | Plans the next irradiation experiment from substrate character, medium, organizing media, and observed result |
